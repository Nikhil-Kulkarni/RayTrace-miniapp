 ...
 *  \details  This namespace provides routines for linear an multi-dimensional linear interpolation
 * of data.
 ...
 */
HOST_DEVICE inline double fast_pow( double x, double y );
 ...
 */
HOST_DEVICE inline double fast_exp_avg( int N, const double *ai, const double *xi );
 ...
 */
HOST_DEVICE inline double get_interp_ratio(
 ...
 * @param f8        f(x2,y2,z2)
 */
inline double trilinear( double dx, double dy, double dz, double f1, double f2, double f3,
 ...
 */
double bilinear( double x, double y, size_t N, size_t M, const double *xgrid, const double *ygrid,
    const double *fgrid );
 ...
 * @param fgrid     function values evaluated at the grid points
 */
double trilinear( double x, double y, double z, size_t N, size_t M, size_t K, const double *xgrid,
 ...
 */
template <class type>
HOST_DEVICE inline void findfirstloop(
 ...
 */
template <class type>
HOST_DEVICE inline void findfirsthash(
    const type *X, const type *Y, size_t *INDEX, size_t size_X, size_t size_Y );
 ...
 */
template <class type>
HOST_DEVICE inline size_t findfirstsingle( const type *X, size_t size_X, type Y );
