...
#include "utilities/RayUtilities.h"     // Include RayTrace::Utilities
#include <iostream>
#include <sstream>
#include <stdexcept>
...
// Include AtomicModel::Utilities
    ...
    namespace AtomicModel {
        namespace Utilities {
            ...
            {
                perr << "Exiting due to abort:\n";
                perr << message << std::endl;
                perr << "called in file: " << filename << std::endl;
                perr << "on line: " << line << std::endl;
                exit(-1);
            }
        }
    }
